  ...
  <div className="container px-0 pt-5">
     ...
     <div className="row align-items-center mb-5 py-5">
      <div className="col-md-6 d-flex flex-column align-items-center text-black">
        ...
        <p className="fs-5">
          Aman creates intuitive and visually appealing user interfaces 
    ...
    <div className="row align-items-center mb-5 py-5">
      ...
      <h4 className="fs-2">
        ...
        <p className="fs-5">
          Jaiendra & Aman Patel
          is a talented UI/UX designer with a keen eye for detail
    ...
    <div className="row align-items-center mb-5 py-5">
      ...
      <h4 className="fs-2">
        ...
        <p className="fs-5">
        Jaiendra specializes in developing robust server-side logic,
    ...
    <div className="row align-items-center mb-5 py-5">
      ...
      <h4 className="fs-2">
        ...
        <p className="fs-5">
          Vishakha is a detail-oriented QA specialist who ensures the
      ...
      <section className="features-section white-bg py-5">
          <div className="container-fluid px-0 text-center">
            ...
            <h5 className="container py-5">Our mission is to help people easily find the right PG accommodation by building a fast, secure, and user-friendly platform. We work closely with engineers to make the search simple, smart, and reliable—with verified listings, real-time updates, and filters for budget, location, and amenities. Our goal is to make the process smooth and stress-free, so users can quickly find a place that feels like home
            </h5>
          </div>
        </section>
